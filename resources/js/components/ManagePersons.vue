                        ...
                        <div class="card-body">
                            <form @submit.prevent="submit" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input v-model="form.name" type="text" class="form-control" placeholder="Nombre de la persona">
                                </div>

                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input v-model="form.email" type="email" class="form-control" placeholder="Email de la persona">
                                </div>
                                <div class="form-group">
                                    <label for="">Avatar</label>
                                    <input accept="image/*" type="file" class="form-control"
                                    @change="handleSelects" ref="avatarInput" name="images">
                                </div>
                                ...
                                <table class="table table-bordered table-hover table-dark">
                                    ...
                                    <tbody>
                                        <tr v-for="person in people" :key="person.id">
                                            ...
                                            <td><img :src="person.avatar_image" :alt="person.name" width="75px" height="75px"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
export default {
    ...
    methods:{
        ...
        submit(){
            ...
            axios.post('people/save', formData, {headers: {'Content-Type':  'multipart/form-data'}})
            .then(res => {
