                            ...
                            <table class="table table-bordered table-hover table-dark">
                                    ...
                                    <tbody>
                                        <tr v-for="product in products" :key="product.id">
                                            <td >
                                                <router-link :to="{name: 'product_show', params:{product: product.id} }" v-tooltip="'Ver Producto'" class="btn btn-sm btn-primary btn-rounded btn-circle">
                                                    <i class="fa fa-eye"></i>
                                                </router-link>
                                                ...
                                                <router-link :to="{name: 'images_show', params:{id: product.id} }" v-tooltip="'Agregar Imagenes del Producto'" class="btn btn-sm btn-info btn-circle">
