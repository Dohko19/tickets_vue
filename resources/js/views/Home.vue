                            ...
                            <div class="row">
                                <div class="col-md-4" v-for="category in categories" :key="category.id">
                                    <div class="card" style="width: 18rem;">
                                        <img class="card-img-top" :src="category.image_category" width="150px" height="150px" :alt="category.name">
                                        <div class="card-body">
                                            <h5 class="card-title" v-text="category.name"></h5>
                                            <p class="card-text" v-text="category.description"></p>
                                            <router-link :to="{name: 'category_show'}"
                                            class="btn btn-primary">Ver mas...</router-link>
                                        </div>
                                    </div>
                                </div>
                            </div>
